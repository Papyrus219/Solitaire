...
void sol::TBoard_factory::Create_middle_stack(TBoard& board, std::vector<std::string> card_order, std::vector<TCard> visible_cards, std::stack<TCard> hidden_cards)
{
    board.Middle_stacks.emplace_back(card_order,visible_cards,hidden_cards);
}

void sol::TBoard_factory::Create_End_stack(TBoard& board, std::vector<std::string> card_order, std::string type, std::vector<std::string> symbols)
{
